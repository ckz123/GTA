...
tplink=TPLinkGNN(twi, in_channels=in_channels, hidden_num_lsmp=128, hidden_num_tfmp=128, 
                 type_link=2, num_layers_lsmp=2, num_layers_tfmp=1, k_topo_dim=128,)
tplink=tplink.to('cuda:0')
mymlp=MyMLP(hidden_dim, 64, 3)
